    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0 justify-content-between d-flex">
                <h6>Daftar Sisa Cuti Karyawan</h6>
            </div>
                    ...
                    <table id="karyawanTable" class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Sisa Cuti</th>
                            </tr>
                        </thead>
...
<script>
    ...
    $(document).ready(function () {
        ...
        axios({
            method: 'get',
            url: baseUrl+'karyawan/sisa-cuti',
            headers: {
        ...
        .then(function (response) {
            var table = datatable(response.data);
        })
